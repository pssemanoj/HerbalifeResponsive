...
{
    class TTInvoicePriceProvider : InvoicePriceProvider
    {
        private readonly IInvoiceShippingDetails _invoiceShipping;

        public TTInvoicePriceProvider(IInvoiceShippingDetails invoiceShipping)
        {
           ...
           string countryCode, bool isReset)
        {
            ...
            if (isReset)
            {
                ...
                invoice.InvoicePrice.TaxPercentage = invoice.InvoicePrice.CalcTaxAmount;
