...
{
    public class USInvoicePriceProvider : InvoicePriceProvider
    {
        private readonly IInvoiceShippingDetails _invoiceShipping;

        public USInvoicePriceProvider(IInvoiceShippingDetails invoiceShipping)
        {
        ...
        private void CalculateTotalDue(InvoiceModel invoice)
        {
        ...
        private void CalculateDiscountedAmount(InvoiceModel invoice)
        {
            var totalAmount = invoice.Type == "Distributor"
                ? invoice.InvoicePrice.TotalEarnBase
                : invoice.InvoicePrice.SubTotal;
