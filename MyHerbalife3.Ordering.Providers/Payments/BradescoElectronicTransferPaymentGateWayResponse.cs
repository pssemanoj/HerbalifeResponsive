...
{
    public class BradescoElectronicTransferPaymentGatewayResponse : PaymentGatewayResponse
    {
        ...
        public BradescoElectronicTransferPaymentGatewayResponse()
        {
        ...
        public override bool CanProcess
        {
            get
            {
                ...
                _configHelper = new ConfigHelper("BradescoElectronicTransferPaymentGateway");


                if (HLConfigManager.Configurations.PaymentsConfiguration.DisableBradesco)
                {
                    canProcess = false;
                }
                else
                {
                    if ((QueryValues[GateWay] == PaymentGateWayName) || (QueryValues[GateWayPost] == PaymentGateWayName))
                    {
                        ...
                        if (!string.IsNullOrEmpty(QueryValues[GateWayPost]) && string.IsNullOrEmpty(QueryValues[Bell]) &&
                            (QueryValues[GateWayPost] == PaymentGateWayName))
                        {
