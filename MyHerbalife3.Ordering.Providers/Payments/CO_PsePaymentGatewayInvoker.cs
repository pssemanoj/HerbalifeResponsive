...
{
    public class CO_PsePaymentGatewayInvoker : PaymentGatewayInvoker
    {
        private CO_PsePaymentGatewayInvoker(string paymentMethod, decimal amount)
            : base("CO_PsePaymentGateway", paymentMethod, amount)
        {
        }
        ...
        public override void Submit()
        {
            ...
            string returnUrl = string.Concat(RootUrl, _configHelper.GetConfigEntry("paymentGatewayReturnUrlApproved"), "?Agency=psepayment");
            string confirmationUrl = string.Concat(RootUrl, _configHelper.GetConfigEntry("paymentGatewayReturnUrlApproved"), "?Agency=psepayment");
            ...
            decimal tax = (null != myCart && null != totals) ? totals.TaxAmount : 0;
