...
namespace MyHerbalife3.Ordering.Providers.Payments
{
    ...
    public class PagosOnlinePaymentGatewayResponse : PaymentGatewayResponse
    {
        ...
        private const string PaymentGateWayName = "PagosOnline";
        ...
        private const string Visa = "10";
        private const string MasterCard = "11";
        private const string AmericanExpress = "12";
        private const string VisaDebit = "27";
        private const string Diners = "22";
        ...
        public PagosOnlinePaymentGatewayResponse()
        {
        ...
        private string GetConfigEntry(string entryName)
        {
            ...
            string entries = Settings.GetRequiredAppSetting("PagosOnlinePaymentGateway");
