<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="APF.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.APF" %>
...
<asp:UpdatePanel ID="upAPF" runat="server">
    <ContentTemplate>
        <asp:Panel ID="pnlAPFIsDueWithinYear" runat="server" meta:resourcekey="pnlAPFResource2"
        ...
        <asp:Panel ID="pnlTesting" runat="server" meta:resourcekey="pnlTestingResource1"
            BorderColor="Red" BorderWidth="1" CssClass="gdo-right-column-tbl gdo-apf-module">
            <div class="gdo-spacer2">
            </div>
            <table>
                <tr>
                    <td>
                        <asp:Label ID="label1" runat="server" Text="Enter New Due Date(mm/dd/yyyy)"></asp:Label>
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        <asp:Button ID="btnTestDueDate" runat="server" Text="Set Due Date" OnClick="SetAPFDueDate"
                            meta:resourcekey="btnTestDueDateResource1" />
                    </td>
                </tr>
                <tr>
                    <td>
                ...
                <tr>
                    <td>
                        Current Due Date:
                        <asp:Label ID="txtApfDate" runat="server" />
                    </td>
                </tr>
            </table>
        </asp:Panel>
