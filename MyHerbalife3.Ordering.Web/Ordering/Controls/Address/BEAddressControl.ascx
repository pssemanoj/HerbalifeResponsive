<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BEAddressControl.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Address.BEAddressControl" %>
<div id="gdo-popup-container">
    ...
    <ul class="gdo-form-label-left gdo-popup-form-label-padding2 three-fields">
        ...
        <li class="group last">
            <ul>
                <li>
                    ...
                    <asp:TextBox runat="server" ID="tbPostalCode" MaxLength="4" AutoPostBack="True" ontextchanged="tbPostalCode_TextChanged"></asp:TextBox>
                    <span class="gdo-form-format">
                        <asp:Localize ID="PostCodeTooltip" runat="server" Text="Format: 1234 (4 digist)" meta:resourcekey="HouseNumberFormat" />
                    </span>
                    <div class="error-message">
                ...
                <li>
                    ...
                    <asp:TextBox runat="server" ID="tbCity" MaxLength="30" Visible="false"></asp:TextBox>
                    <asp:DropDownList runat="server" ID="ddlCity"></asp:DropDownList>
                    <div class="error-message">
                        <asp:CustomValidator id="cvCity" runat="server"
                                        OnServerValidate="ddlCity_OnServerValidate"
        ...
        <li class="last">
            ...
            <asp:TextBox runat="server" ID="tbPhoneNumber" MaxLength="11"></asp:TextBox>
            <div class="error-message">
        ...
        <li class="help-text">
            <span class="gdo-form-format">
                <asp:Localize ID="PhoneNumberTooltip" runat="server" Text="Format 9-10 numbers" meta:resourcekey="PhoneNumberTooltip" />
            </span>
        </li>
    </ul>
</div>
