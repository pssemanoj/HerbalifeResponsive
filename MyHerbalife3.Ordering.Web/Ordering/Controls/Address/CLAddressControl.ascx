<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CLAddressControl.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Address.CLAddressControl" %>
