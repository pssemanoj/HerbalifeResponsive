...
{
    public partial class HNAddressControl : AddressControlBase
    {
        ...
        protected override string StateProvince
        {
            ...
            get
            {
                return dnlState.SelectedItem == null || dnlState.SelectedValue == string.Empty ?
                    string.Empty : dnlState.SelectedItem.Text;
            }
        }
        ...
        protected override string County
        {
            get
            {
                return dnlVillage.SelectedItem == null || dnlVillage.SelectedValue == string.Empty ?
                    string.Empty : dnlVillage.SelectedItem.Text;
            }
            set
            {
                ListItem item = dnlVillage.Items.FindByText(value);
                dnlVillage.SelectedIndex = -1;
                if ( item != null )
                {
                    item.Selected = true;
                }
        ...
        public override void LoadPage()
        {
            if (_shippingAddr != null)
            {
                ...
                LookupVillages(StateProvince, _shippingAddr.Address.City);
        ...
        protected void dnlCity_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                LookupVillages(dnlState.SelectedItem.Value, dnlCity.SelectedItem.Value);
                dnlVillage.Focus();
            }
            else
            {
                dnlVillage.Items.Clear();
                dnlVillage.Text = string.Empty;
            }
        }
