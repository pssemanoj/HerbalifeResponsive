<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="KZAddressControl.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Address.KZAddressControl" %>
<div id="gdo-popup-container">
    ...
    <ul class="gdo-form-label-left gdo-popup-form-label-padding2">
        ...
        <li><asp:Label runat="server" ID="lbCounty" Text="Area Code:" meta:resourcekey="lbCounty"></asp:Label>
            <asp:TextBox runat="server" ID="txtCounty" MaxLength="30" ></asp:TextBox>
        </li>
    </ul>
    ...
    <ul class="gdo-form-label-left gdo-popup-form-label-padding2">
       ...
       <%-- <li><asp:Label runat="server" ID="lbPostal" Text="Postal Code:" meta:resourcekey="lbPostal"></asp:Label>
        ...
        <li class="help-text"><span class="gdo-form-format">
                <asp:Localize ID="Localize1" runat="server" meta:resourcekey="PostalCodeFormat" Text="6 numbers no spaces"></asp:Localize>
            </span>
        </li>--%>
       

        <li><asp:Label runat="server" ID="lbPhoneNumber" Text="Phone Number:" meta:resourcekey="lbPhoneNumber"></asp:Label>
            <asp:TextBox runat="server" ID="txtNumber" MaxLength="15" meta:resourcekey="txtNumberResource1"></asp:TextBox>
        </li>
        <li class="help-text"><span class="gdo-form-format">
                <asp:Localize ID="Localize2" runat="server" meta:resourcekey="PhoneNumberFormat" Text="15 numbers no spaces"></asp:Localize>
            </span>
        </li>
