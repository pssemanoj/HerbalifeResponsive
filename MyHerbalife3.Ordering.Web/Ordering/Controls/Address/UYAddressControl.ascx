<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UYAddressControl.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Address.UYAddressControl" %>
        ...
        <li class="group last">
            <ul>
                ...
                <li class="last">
                    ...
                    <asp:TextBox runat="server" ID="txtPostalCode" MaxLength="5" meta:resourcekey="dnltPostalCodeResource"></asp:TextBox>
                    <span class="gdo-form-format">
                         <asp:Localize ID="Localize1" Text="Format: 4 digits" runat="server" meta:resourcekey="PostCodeFormat"/>
                    </span>
                </li>
            </ul>
        </li>
        ...
        <li class="group last">
            <ul>
                ...
                <li class="help-text gdo-form-format">
                    <asp:Localize ID="Localize2" runat="server" meta:resourcekey="PhoneNumberFormat">Format: 7-10 digits</asp:Localize>
                </li>
            </ul>
        </li>
    </ul>
