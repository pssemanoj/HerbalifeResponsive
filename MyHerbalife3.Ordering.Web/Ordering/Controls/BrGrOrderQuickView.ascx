<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="BrGrOrderQuickView.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.BrGrOrderQuickView" %>
...
<input type="hidden" id="uiId_BrGrOrderQuickView_DeliveryType" name="uiId_BrGrOrderQuickView_DeliveryType" value="<%=DeliveryType.UniqueID%>" />
                    ...
                    <div class="gdo-input-container" runat="server" id="divDeliveryOptionSelection">
                        ...
                        <div class="gdo-select-box">
                            <asp:DropDownList AutoPostBack="True" runat="server" ID="DeliveryType" OnSelectedIndexChanged="OnDeliveryTypeChanged"
                                ...
                                <asp:ListItem Text="Pick up from Courier office" Value="PickupFromCourier1" meta:resourcekey="ListItemResource7"></asp:ListItem>
                                <asp:ListItem Text="Pickup" Value="Pickup1" meta:resourcekey="ListItemResource8"></asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
