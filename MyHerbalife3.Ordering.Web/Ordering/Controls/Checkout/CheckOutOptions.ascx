<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckOutOptions.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.CheckOutOptions" %>
...
<asp:UpdatePanel ID="upCheckOutOptions" runat="server">
    <ContentTemplate>
        <table>
                    ...
                    <div id="DeliveryOptionsInstructionsView" class="checkout-shipmethod" runat="server">                       
                        ...
                        <div runat="server" id="divDeliveryMethodShipping">
                            <table class="delivery-method">
                                ...
                                <tr runat="server" id="trEditableDeliveryDate">
                                    <td>
                                        <asp:Label runat="server" ID="DeliveryDate" Text="Delivery Date:" meta:resourcekey="DeliveryDateResource1"></asp:Label>
                                    </td>
                                    <td>
                                        <div id="Div2">
                                            <telerik:RadDatePicker runat="server" ID="DeliveryDateTextBox" CssClass="rsAdvDatePicker"
                                                MinDate="1900-01-01" ZIndex="10000" EnableTyping="False"
                                                meta:resourcekey="pickupdateTextBoxResource1">
                                                <Calendar ID="Calendar3" runat="server" FastNavigationStep="12" ShowRowHeaders="false">
                                                </Calendar>
                                                <DatePopupButton Visible="true" />
                                                <DateInput ID="DateInput2" runat="server" EmptyMessageStyle-CssClass="radInvalidCss_Default"
                                ...
                                <tr runat="server" id="trStaticDeliveryDate">
                                    <td>
                                        <asp:Label runat="server" ID="DeliveryDate2" Text="Delivery Date:" meta:resourcekey="DeliveryDateResource1"></asp:Label></b>
                                    </td>
                                    <td>
                                        <asp:Label runat="server" ID="lbDeliveryDate" Text="Delivery Date:" meta:resourcekey="DeliveryDateResource1"></asp:Label>
                                    </td>
                                </tr>
                        ...
                        <div runat="server" id="divDeliveryMethodPickup">
                            <table>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label runat="server" ID="lblMessage" Text="Message for 7-11" meta:resourcekey="Message" ></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr runat="server" id="trEditablePickupPhone">
                                  ...
                                  <tr runat="server" id="trEditablePickupPhoneFormat" Visible="false">
                                    <td></td>
                                    <td style="white-space:nowrap">
                                        <asp:Label ID="PickupPhoneFormat" runat="server" Text="PickUpPhoneFormat:1111111111" Font-Size="Smaller" meta:resourcekey="lbPickupPhoneFomat" ForeColor="Red"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr runat="server" id="trEditablePickUpTinCode">
                                    <td>
                                        <asp:Label runat="server" ID="PickUpTinCode" Text="Pickup TinID" meta:resourcekey="PickupTinIDResource1"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtPickupTinID" CssClass="inputPickupName" MaxLength="4" OnTextChanged="OnPickupTinID_Changed"
                                            meta:resourcekey="txtPickupTinIDResource1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr runat="server" id="trStaticPickUpTinCode">
                                    <td>
                                        <asp:Label runat="server" ID="PickUpTinCodeStatic" Text="Pickup TinID" meta:resourcekey="PickupTinIDResource1"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:Label runat="server" ID="lblPickUpTinCode" Text="Pickup TinID" meta:resourcekey="lblPickupTinIDResource1"></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <cc1:ContentReader ID="ContentReader4" runat="server" ContentPath="pickupauthorization.html"
                                            SectionName="ordering" ValidateContent="true" UseLocal="true" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div id="DeliveryTerms" runat="server" class="checkout-shipmethod" visible="false">
                        ...
                        <div>
                            <table class="delivery-method">
                                <tr>
                                    <td colspan="2">
                                        <cc1:ContentReader ID="ContentReader3" runat="server" ContentPath="deliveryterms.html"
                                            SectionName="ordering" ValidateContent="true" UseLocal="true" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="checkout-email" runat="server">
                        ...
                        <div id="dvEmailEdit" runat="server">
                            <div runat="server" id="dvMobileNumber" class="ntbox-email">
                                ...
                                <br />
                                <span>
                                    <asp:TextBox runat="server" ID="txtMobileAreaCode" OnTextChanged="txtMobileAreaCode_Changed"
                            ...
                            <div class="ntbox-msg">
                                <asp:Label ID="lblEmailBoxText1" runat="server" Text="Herbalife will send your order confirmation, status, or updates to this email address:"
                                    meta:resourcekey="lblEmailBoxText1"></asp:Label>
                            </div>
                        ...
                        <br />
                        <div id="dvFreightChange" runat="server" >
                             <asp:CheckBox ID="cbFreightchanges" runat="server"
                       Text="" meta:resourcekey="cbFreightchangesRes"  Font-Bold="true" name="cbFreightchanges" />
                        </div>
                    </div>
                </td>
            </tr>
            <tr>
                <td>
                    <div id="divSentence" runat="server" visible="false">
                        <asp:Label runat="server" ID="lblSentence"
                            Text="" meta:resourcekey="lblSentenceRes"></asp:Label>
                    </div>
                </td>
            </tr>
        </table>
