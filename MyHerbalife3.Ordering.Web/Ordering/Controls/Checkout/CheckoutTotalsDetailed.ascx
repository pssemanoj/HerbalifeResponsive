<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CheckoutTotalsDetailed.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.CheckoutTotalsDetailed" %>
...
<div class="gdo-order-details-wrapper">
    ...
    <div class="gdo-order-details-container-last col-md-4">
        ...
        <table class="gdo-order-details-tbl">
            ...
            <tr runat="server" id="trPCLearningPoint" Visible="false">
                <td class="gdo-details-label">
                    <asp:Label ID="lblPCLearningPoint" Text="PC Learning OffSet" runat="server" meta:resourcekey="lblPCLearningPointResource1" />:
                </td>
                <td class="gdo-details-value">
                    <asp:Label ID="lblPCLearningPointAmount" runat="server" />
                </td>
            </tr>
            <tr>
                <td class="gdo-details-label">
