<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GrCheckOutOptions.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.GrCheckOutOptions" %>
        ...
        <table>
            <tr>
                <td id="checkout-stepone">
                        <cc1:ContentReader ID="ContentReader6" runat="server" ContentPath="CheckoutImportantNotification.html"
                    ...
                    <div id="DeliveryOptionsView" class="checkout-ship-pick-options" runat="server">
                        ...
                        <div class="gdo-input-container" id="divDeliveryOptionSelection" runat="server">
                            ...
                            <div class="gdo-select-box">
                                <asp:DropDownList AutoPostBack="True" runat="server" ID="DeliveryType" OnSelectedIndexChanged="OnDeliveryTypeChanged"
                                    ...
                                    <asp:ListItem Text="Pick up from Courier office" Value="PickupFromCourier1" meta:resourcekey="DeliveryOptionType_PickupFromCourier1"></asp:ListItem>
                                    <asp:ListItem Text="Pickup" Value="Pickup1" meta:resourcekey="DeliveryOptionType_Pickup1"></asp:ListItem>
                                </asp:DropDownList>
                                <asp:Label ID="lblSelectedDeliveryType" runat="server" Visible="false" name="lblSelectedDeliveryType"></asp:Label>
                            </div>
                        </div>
                        ...
                        <div class="gdo-input-container" id="divNicknameSelection" runat="server">
                            ...
                            <div class="gdo-select-box">
                                <asp:Label runat="server" ID="lblNickName" Visible="false" name="lblNickName"></asp:Label>
                        ...
                        <div class="gdo-shipto-container" id="divshipToOrPickup" runat="server">
                            ...
                            <p runat="server" visible="true" id="pAddress" name="pAddress">
                            </p>
                        </div>
                        <div class="gdo-shipto-container" id="divLocationInformation" runat="server">
                            <div class="gdo-right-column-labels">
                                <asp:Label runat="server" ID="pickUpAddInfoHeader" Text="Additional Info:" meta:resourcekey="pickUpAddInfoHeaderResource1"></asp:Label>
                                <p runat="server" visible="true" id="pInformation">
                                </p>
                                <p runat="server" visible="false" id="pInformation2">
                                </p>
                            </div>
                        </div>
                        <div runat="server" id="divLinks">
                            <div id="divLinkAdd" runat="server" class="inline">
                                <asp:LinkButton runat="server" ID="LinkAdd" Text="Add" OnClick="AddClicked" meta:resourcekey="LinkAddResource1" name="linkAdd"></asp:LinkButton>&nbsp;
                            </div>
                            <div id="divLinkEdit" runat="server" class="inline">
                                <span class="gdo-right-column-text">|</span>&nbsp;
                                <asp:LinkButton runat="server" ID="LinkEdit" Text="Edit" OnClick="EditClicked" meta:resourcekey="LinkEditResource1" name="linkEdit"></asp:LinkButton>&nbsp;                                
                            </div>
                            <div id="divLinkDelete" runat="server" class="inline">
                                ...
                                <asp:LinkButton runat="server" ID="LinkDelete" OnClick="DeleteClicked" Text="Delete"
                                    meta:resourcekey="LinkDeleteResource1" name="linkDelete"></asp:LinkButton>                                
                            </div>
                        </div>
                        <div class="clear"></div>
                    ...
                    <div id="DeliveryOptionsInstructionsView" class="checkout-shipmethod" runat="server">
                        ...
                        <div runat="server" id="divDeliveryMethodShipping">
                            <table class="delivery-method">
                                ...
                                <tr runat="server" id="trStaticShippingMethod">
                                    <td colspan="2">
                                        <asp:Label runat="server" ID="lbShippingMethod" meta:resourcekey="lbShippingMethodResource1" name="lbShippingMethod"></asp:Label>
                                    </td>
                                </tr>
                        ...
                        <div runat="server" id="divDeliveryMethodPickup">
                            <table id="tbShippingMethodForPickup" runat="server" class="delivery-method">
                                <tr>
                                    <td colspan="2">
                                        <cc1:ContentReader ID="ContentReader4" runat="server" ContentPath="ShippingMethodForPickup.html"
                                            SectionName="ordering" ValidateContent="true" UseLocal="true" />
                                    </td>
                                </tr>
                                <tr runat="server" id="trEditableShippingMethodForPickup">
                                    <td colspan="2">
                                        <cc2:NostalgicDropDownList runat="server" ID="ddlShippingMethodPickup" DataTextField="Description"
                                            DataValueField="FreightCode" AutoPostBack="True" OnSelectedIndexChanged="ddlShippingMethodPickup_OnSelectedIndexChanged"
                                            OnDataBound="ddlShippingMethodPickup_OnDataBound" meta:resourcekey="ddlShippingMethodPickupResource">
                                        </cc2:NostalgicDropDownList>
                                    </td>
                                </tr>
                                <tr runat="server" id="trStaticShippingMethodForPickup">
                                    <td colspan="2">
                                        <asp:Label runat="server" ID="lbShippingMethodPickup" meta:resourcekey="lbShippingMethodPickupResource"></asp:Label>
                                    </td>
                                </tr>
                            </table>
                            <table>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <asp:Label runat="server" ID="lblMessage" Text="Message for 7-11" Visible=""  meta:resourcekey="Message" ></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <tr runat="server" id="trEditablePickupPhone">
                                    ...
                                    <td>
                                        ...
                                        <asp:Label runat="server" ID="lblformatPickupPhone" meta:resourcekey="PickUpPhoneFormatResource1" Visible="False" ></asp:Label>
                                    </td>
                                </tr>
                                ...
                                <!-- RG# Field -->
                                <%--								<tr runat="server" id="trEditableRGNumber" style="display:none;">
                                    <td>
                                        <asp:Label runat="server" ID="lblRGNumber" Text="RG#" meta:resourcekey="lblRGNumberResource"></asp:Label>
                                    </td>
                                    <td>
                                        <asp:TextBox runat="server" ID="txtRGNumber" CssClass="inputPickupPhone" OnTextChanged="OnPickupPhone_Changed"  meta:resourcekey="txtPickupPhoneResource1"></asp:TextBox>
                                    </td>
                                </tr>
                                <tr runat="server" id="trStaticRGNumber" style="display:none;">
                                    <td>
                                        <asp:Label runat="server" ID="lblRGNumberStatic" Text="RG#" meta:resourcekey="lblRGNumberResource"></asp:Label></td>
                                    <td>
                                        <asp:Label runat="server" ID="lblRGNumberValue"></asp:Label></td>
                                </tr>
                                --%>
                                <!-- End RG# Field -->
                    ...
                    <div id="DeliveryTerms" runat="server" class="checkout-shipmethod" visible="false">
                        <div class="gdo-right-column-header">
                            <h3>
                                <asp:Label runat="server" ID="Label1" Text="Terms of Delivery" meta:resourcekey="TextDeliveryTerms"></asp:Label></h3>
                        </div>
                        <div class="gdo-clear gdo-horiz-div">
                        </div>
                        <div>
                            <table class="delivery-method">
                                <tr>
                                    <td colspan="2">
                                        <cc1:ContentReader ID="ContentReader5" runat="server" ContentPath="deliveryterms.html"
                                            SectionName="ordering" ValidateContent="true" UseLocal="true" />
                                    </td>
                                </tr>
                            </table>
                    ...
                    <div class="checkout-email" runat="server">
                        ...
                        <div id="dvEmailEdit" runat="server">
                            ...
                            <div runat="server" id="dvSingleTextBoxNumber" class="ntbox-email">
                                ...
                                <br />
                                <span>
                                    <asp:TextBox runat="server" MaxLength="10" ID="txtSingleMobileNumber" OnTextChanged="txtSingleMobileNumber_Changed"
                        ...
                        <div id="dvEmailReadOnly" runat="server" visible="false">
                            <div class="ntbox-email">
                                ...
                                <asp:Label ID="lblShortEmail" runat="server" name="lblShortEmail"></asp:Label>
