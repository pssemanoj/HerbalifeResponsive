<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentsSummary.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.PaymentsSummary" %>
<%@ Register Src="~/Ordering/Controls/Payments/StaticPaymentInfo.ascx" TagName="pInfo" TagPrefix="uc" %>
