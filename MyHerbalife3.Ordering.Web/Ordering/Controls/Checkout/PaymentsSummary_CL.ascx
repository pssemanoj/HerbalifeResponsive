<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentsSummary_CL.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.PaymentsSummary_CL" %>
<%@ Register Src="~/Ordering/Controls/Payments/PaymentGateways/StaticPaymentInfo_es-CL.ascx" TagName="pInfo" TagPrefix="uc" %>
