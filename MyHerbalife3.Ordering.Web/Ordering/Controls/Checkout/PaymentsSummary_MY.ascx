<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentsSummary_MY.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.PaymentsSummary_MY" %>
<%@ Register Src="~/Ordering/Controls/Payments/PaymentGateways/StaticPaymentInfo_MY.ascx" TagName="pInfo" TagPrefix="uc" %>
