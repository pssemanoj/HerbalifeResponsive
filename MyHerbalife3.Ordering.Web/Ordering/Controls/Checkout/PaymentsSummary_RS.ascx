<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentsSummary_RS.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Checkout.PaymentsSummary_RS" %>
<%@ Register Src="~/Ordering/Controls/Payments/PaymentGateways/StaticPaymentInfo_sr-RS.ascx" TagName="pInfo" TagPrefix="uc" %>
