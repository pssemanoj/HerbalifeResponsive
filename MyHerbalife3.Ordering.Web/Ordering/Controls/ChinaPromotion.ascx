<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ChinaPromotion.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.ChinaPromotion" %>
        ...
        <ContentTemplate>
            <div class="gdo-right-column-tbl gdo-hff-module" runat="server" id="divPromo">
                ...
                <div class="gdo-right-column-text gdo-tdmag-radio" id="dvFreeGiftSKU" runat="server">
                    ...
                    <asp:RadioButtonList ID="rblFreeGiftlist" runat="server" EnableViewState="true"></asp:RadioButtonList>           
