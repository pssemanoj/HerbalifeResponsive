<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GHFFModal.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.GHFFModal" %>
...
<telerik:RadCodeBlock ID="RCScript" runat="server">
    <script type="text/javascript">
        ...
        var divPaymentInfo = "<%= divPaymentInfo.ClientID %>";
        ...
        <ContentTemplate>
            <div id="divHFFDonation_Step1" class="gdo-popup" runat="server">
                ...
                <cc1:DynamicButton runat="server" ID="btnNo" ButtonType="Neutral"
                                    OnClientClick="OnCancel()" meta:resourcekey="btnNo" Text="No Thanks" />
            ...
            <div id="divHFFDonation_Step2" class="gdo-popup" runat="server">
                <div id="divHeader">
                ...
                <div id="divOrderComplete"  runat="server">
                ...
                <div id="divEmailNotification" runat="server">
...
<%-- ReSharper disable ResourceItemNotResolved --%>
                    <asp:Label ID="lbPaymentInfo" runat="server" Text="PaymentInformation" meta:resourcekey="lbPaymentInfo"></asp:Label>
<%-- ReSharper restore ResourceItemNotResolved --%>
                ...
                <div id="divSubmitCommand" runat="server">
                    ...
                    <cc1:DynamicButton runat="server" ID="btnCancel" ButtonType="Neutral"
                                    OnClientClick="OnCancel()" meta:resourcekey="btnCancel" Text="Cancel" />
                    <cc1:DynamicButton runat="server" ID="btnBack" ButtonType="Neutral"
                                    OnClientClick="OnStep1()" meta:resourcekey="btnBack" Text="Back" />
                ...
                <div id="divEndCommand" class="hide" runat="server">
                    ...
                    <cc1:DynamicButton runat="server" ID="btnDone" ButtonType="Forward"
                                    OnClientClick="OnCancel()" meta:resourcekey="btnDone" Text="Done" />
                </div>
            </div>
        </ContentTemplate>
        <Triggers>
