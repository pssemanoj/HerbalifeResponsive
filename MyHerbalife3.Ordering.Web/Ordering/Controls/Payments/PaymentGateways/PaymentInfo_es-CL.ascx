<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfo_es-CL.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentGateways.PaymentInfo_es_CL" %>
