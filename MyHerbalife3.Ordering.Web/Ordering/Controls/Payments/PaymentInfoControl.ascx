<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoControl.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoControl" %>
                            ...
                            <div>
                                <div id="dvCardDetails" runat="server" class="hl-form-left">
                                    ...
                                    <asp:DropDownList ID="ddlCardType" runat="server"
                                                        meta:resourcekey="ddlCardTypeResource1" TabIndex="3">
                                    ...
                                    <asp:Panel ID="pnlExpDate" runat="server" Width="100%" Style="white-space: nowrap" meta:resourcekey="pnlExpDateResource1">
                                        ...
                                        <li>
                                            ...
                                            meta:resourcekey="txtNickNameResource1" TabIndex="6"></asp:TextBox>
                                        </li>
