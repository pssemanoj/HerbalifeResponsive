<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoGrid_CO.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoGrid_CO" %>
    ...
    <ContentTemplate>
        <asp:Panel ID="pnlSelectPager" runat="server" CssClass="pmtbox" meta:resourcekey="pnlSelectPagerResource1">
            <asp:RadioButtonList runat="server" ID="rblPaymentOptions" Style="width: 80%" RepeatDirection="Horizontal"
                ...
                <asp:ListItem Text="Payment Gateway PSE" Value="5" meta:resourcekey="ListItemResource5"></asp:ListItem>
        ...
        <asp:Panel ID="pnlPaymentOptions" runat="server">
            <rad:RadMultiPage runat="server" ID="mpPaymentOptions" SelectedIndex="0" meta:resourcekey="mpPaymentOptionsResource1">
                ...
                <rad:RadPageView ID="pvPaymentGatewayPSE" runat="server" CssClass="MultiPage" meta:resourcekey="pvPaymentGatewayResourcePSE">
                    <asp:Panel runat="server" ID="pnlPaymentGatewayTablePSE" meta:resourcekey="pnlPaymentGatewayTableResourcePSE1">
                        <table>
                            <tr>
                                <td>
                                    <cc1:ContentReader ID="paymentGatewayPSEMessage" runat="server" ContentPath="lblPaymentGatewayPSEMessage.html"
                                        SectionName="Ordering" ValidateContent="true"  UseLocal="true" />
                                </td>
                            </tr>
                        </table>
