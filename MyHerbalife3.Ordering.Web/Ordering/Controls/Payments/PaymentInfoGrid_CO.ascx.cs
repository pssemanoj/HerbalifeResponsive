...
namespace MyHerbalife3.Ordering.Web.Ordering.Controls.Payments
{
    ...
    public partial class PaymentInfoGrid_CO : UserControlBase, PaymentInfoBase
    {
        #region Enums
        ...
        public bool IsUsingPaymentGateway
        {
            get
            {
                ...
                return paymentOption == PaymentOptionChoice.PaymentGateway || paymentOption == PaymentOptionChoice.PaymentGatewayPse;
            }
        }
        ...
        public List<Payment> GetPayments(Address_V01 shippingAddress)
        {
            ...
            switch (choice)
            {
                ...
                case PaymentOptionChoice.PaymentGatewayPse:
                    {
        ...
        {
            var onlineDistributor = Membership.GetUser() as OnlineDistributor;
                ...
                case PaymentOptionChoice.PaymentGatewayPse:
                    {
                        ...
                        cp.PaymentOptions = options;
                        cp.AuthorizationMethod = AuthorizationMethodType.PaymentGateway;
                        cp.TransactionType = GetLocalResourceObject("ListItemResource5.Text") as string;
                        cp.AuthorizationCode = "654321";
                        cp.TransactionID = (null != _paymentGatewayResponse)
                                               ? _paymentGatewayResponse.TransactionCode
                                               : Guid.NewGuid().ToString();
                ...
                case PaymentOptionChoice.WireTransfer:
                    {
                        ...
                        wp.ReferenceID = onlineDistributor != null && onlineDistributor.Value != null
                                             ? onlineDistributor.Value.ReferenceNumber
                                             : string.Empty;
        ...
        private List<PaymentInformation> CreateDummyPayment(bool createPaymentInformation)
        {
            ...
            if (createPaymentInformation)
            {
                ...
                info.BillingAddress = new ServiceProvider.OrderSvc.Address_V01("950W 190th Street", string.Empty, string.Empty, string.Empty,
                                                      "Torrance", "Los Angeles", "CA", _countryCode, "90502");
                info.CardHolder = new ServiceProvider.OrderSvc.Name_V01() { First = "Gerry", Last = "Hayes" };
        ...
        private void SetupPaymentMethodDisplay()
        {
            ...
            rblPaymentOptions.Items.FindByValue("2").Attributes.Add(HtmlTextWriterAttribute.Style.ToString(), StyleHidden);
            rblPaymentOptions.Items.FindByValue("3").Attributes.Add(HtmlTextWriterAttribute.Style.ToString(), StyleHidden);
            rblPaymentOptions.Items.FindByValue("4").Attributes.Add(HtmlTextWriterAttribute.Style.ToString(), StyleHidden);
            rblPaymentOptions.Items.FindByValue("5").Attributes.Add(HtmlTextWriterAttribute.Style.ToString(), StyleHidden);
            ...
            if (_enableInstallments)
            {
                ...
                {
                    var cardInfoWire =
                        (from c in _installmentsConfiguration.Cards.Card where c.CardId == "Wire" select c)
                            .FirstOrDefault();
            ...
            if (_UsesPaymentGateway)
            {
                ...
                if (HLConfigManager.Configurations.PaymentsConfiguration.HidePse)
                {
                    rblPaymentOptions.Items.FindByValue("5").Attributes.Add(HtmlTextWriterAttribute.Style.ToString(), StyleHidden);
                }
            }
            ...
            {
                rblPaymentOptions.Items.FindByValue("3").Attributes.Remove(HtmlTextWriterAttribute.Style.ToString());
            ...
            if (_allowDirectDepositPayment)
            {
                ...
                rblPaymentOptions.Items.FindByValue("4").Attributes.Remove(HtmlTextWriterAttribute.Style.ToString());
            ...
            if (!HLConfigManager.Configurations.PaymentsConfiguration.HidePse)
            {
                rblPaymentOptions.Items.FindByValue("5").Attributes.Remove(HtmlTextWriterAttribute.Style.ToString());
                pnlPaymentGatewayTablePSE.Visible = true;
            }
        ...
        protected PaymentOptionChoice GetCurrentPaymentOption()
        {
            ...
            switch (mpPaymentOptions.SelectedIndex)
            {
                ...
                case 2:
                    {
                        choice = PaymentOptionChoice.PaymentGatewayPse;
                        break;
                    }
                case 3:
                    {
                                                   ...
                                                   bool showErrors)
        {
            ...
            else if ((null != _paymentGatewayControl && null == _paymentGatewayControl as PaymentInfo_Generic) && currentChoice == PaymentOptionChoice.PaymentGateway)
            {
            ...
            else if(currentChoice == PaymentOptionChoice.PaymentGatewayPse)
            {
