<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoGrid_IN.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoGrid_IN" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlSelectPager" runat="server" CssClass="pmtbox" meta:resourcekey="pnlSelectPagerResource1">
            <asp:RadioButtonList runat="server" ID="rblPaymentOptions" Style="width: 80%" RepeatDirection="Horizontal"
                ...
                <asp:ListItem Text="Net Banking" Value="6" meta:resourcekey="ListItemResource6"></asp:ListItem>               
                <asp:ListItem Text="Wire Transfer" Value="3" meta:resourcekey="ListItemResource3"></asp:ListItem>
                <asp:ListItem Text="Direct Deposit" Value="5" meta:resourcekey="ListItemResource4"></asp:ListItem>
                <asp:ListItem Text="ICICI Bank iSure Pay (Auto Order Release)" Value="4" meta:resourcekey="ListItemResource5"></asp:ListItem>
        ...
        <asp:Panel ID="pnlPaymentOptions" runat="server">
            <rad:RadMultiPage runat="server" ID="mpPaymentOptions" SelectedIndex="0" meta:resourcekey="mpPaymentOptionsResource1" CssClass="mpPaymentOptions">
                ...
                <rad:RadPageView ID="pvPaymentGatewayNetbanking" runat="server" CssClass="MultiPage" meta:resourcekey="pvPaymentGatewayNetbanking">
                    <asp:Panel runat="server" ID="pnlPaymentGatewayTableNetbanking" meta:resourcekey="pnlPaymentGatewayTableResourceNetbanking1">
                        <table>
                            <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblNetBankingAmountDue" runat="server" Text="Total Net Banking Amount: " meta:resourcekey="lblNetBankingAmountDueResource1" />
                                                <asp:Label ID="totalNetBankingDue" runat="server" meta:resourcekey="totalNetBankingDueResource1" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <cc1:ContentReader ID="paymentGatewayNetbankingMessage" runat="server" ContentPath="lblNetbanking.html" SectionName="Ordering" ValidateContent="true" UseLocal="true"/>
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
                ...
                <rad:RadPageView ID="pvWireAutoOrder" runat="server">
                    <asp:Panel runat="server" ID="pnlWireTransferAutoOrder" meta:resourcekey="pnlWireTableResource1">
                    <table>
                           <tr>
                                <td>
                                    <table>
                                        <tr>
                                            <td>
                                                <asp:Label ID="lblWireAutoOrderDue" runat="server" Text="Total Wire Amount Due:" meta:resourcekey="lblWireAmountDueResource1" />
                                                <asp:Label ID="totalWireAutoOrderRelease" runat="server" meta:resourcekey="totalWireDueResource1" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <cc1:ContentReader ID="cReaderAutoOrder" runat="server" ContentPath="lblWireTransferAutoOrderRelease.html" SectionName="Ordering" ValidateContent="true" UseLocal="true" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
            ...
            <asp:Panel ID="pnlAcknowledCheckContent" runat="server" CssClass="errorConfirm full-width" Visible="false">
