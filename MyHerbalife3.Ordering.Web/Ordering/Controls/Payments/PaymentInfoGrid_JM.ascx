<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoGrid_JM.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoGrid_JM" %>
...
<div style="display: none;">
    <input type="button" id="callserver" value="Accept" click="FillDataCreditCard" runat="server"
        visible="False" />
</div>

<asp:HiddenField ID="HiddenAmount" runat="server" />
<asp:HiddenField ID="HiddenCVV" runat="server" />
                                            ...
                                            <asp:TemplateField meta:resourcekey="TemplateFieldResource2">
                                                ...
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCVV" runat="server" AutoCompleteType="None" CssClass="gdo-product-qty"
                                                        OnClientClick="fillDataCodeBehind()" Enabled='<%# isExpires(DateTime.Parse(Eval("Expiration").ToString())) == false %>'
                                                        size="3" AutoPostBack="false"></asp:TextBox>
                                                </ItemTemplate>
                                                <ControlStyle CssClass="gdo-order-tbl-data-center" />
                                                <HeaderStyle HorizontalAlign="Center" />
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Amount" meta:resourceKey="Amount">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtAmount" runat="server" CssClass="gdo-product-qty" Enabled='<%# isExpires(DateTime.Parse(Eval("Expiration").ToString())) == false %>'
                                                        size="6" OnClientClick="fillDataCodeBehind()" OnTextChanged="FillDataCreditCard"
...
<asp:Panel ID="PayOptionsQH" CssClass="gdo-right-column-tbl gdo-hff-module" runat="server"
    Style="border-style: solid; border-width: thin; width: 190px; height: 270px; background-color: White"
