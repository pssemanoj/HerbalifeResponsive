<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoGrid_TW.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoGrid_TW" %>
                        ...
                        <table>
                            ...
                            <tr>
                                <td>
                                    <p>
                                        <strong>
                                                <br /><asp:Literal runat="server" ID="smsMobileTitle" meta:resourcekey="smsMobileTitle">Bank Wire Transfer / ATM / internet bank transfer (payment) Information</asp:Literal>
                                        </strong>
                                        <br />
                                    </p>
                                    <p>
                                        <p><asp:Literal runat="server" ID="smsMobileMessage" meta:resourcekey="smsMobileMessage">SMS confirmation - please be sure to enter your mobile phone number in order to facilitate the transfer of remittances account to your SMS.</asp:Literal><br /></p>
                                        <asp:TextBox runat="server" ID="txtSMSMobile" MaxLength="10" meta:resourcekey="txtSMSMobileResource1" CssClass="onlyNumbers"></asp:TextBox><br />
                                        <p><span style="color:#888"><asp:Localize ID="smsMobileFormat" runat="server"  meta:resourcekey="smsMobileFormat">Mobile phone number (such as non-local calls, please telephone before adding country / area code)</asp:Localize></span></p>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <cc1:ContentReader ID="wireMessage" runat="server" ContentPath="lblWireMessageWithSMS.html" SectionName="Ordering" ValidateContent="true" UseLocal="true" />
                                </td>
                            </tr>
                        </table>
                    </asp:Panel>
