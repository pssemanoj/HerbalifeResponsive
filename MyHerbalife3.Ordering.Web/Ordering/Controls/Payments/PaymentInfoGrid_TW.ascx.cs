...
namespace MyHerbalife3.Ordering.Web.Ordering.Controls.Payments
{
    ...
    public partial class PaymentInfoGrid_TW : UserControlBase, PaymentInfoBase
    {
        ...
        private void SetWirePayments()
        {
            ...
            if (null != aliases && null != codes && aliases.Count > 0 && codes.Count > 0)
            {
                ...
                txtSMSMobile.Text = string.IsNullOrEmpty(this.ShoppingCart.SMSNotification) ? txtSMSMobile.Text : this.ShoppingCart.SMSNotification;
            }
            else
            {
                LoggerHelper.Error(
                                                   ...
                                                   bool showErrors)
        {
            ...
            else if (currentChoice == PaymentOptionChoice.WireTransfer)
            {
                ...
                {
                    lblErrorMessages.Text = PlatformResources.GetGlobalResourceString("ErrorMessage", "NoSMSNumber");
                    isValid = false;
                }
                else if (!string.IsNullOrEmpty(txtSMSMobile.Text) &&
