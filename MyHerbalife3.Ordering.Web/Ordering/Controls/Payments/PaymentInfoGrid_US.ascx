<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoGrid_US.ascx.cs" 
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoGrid_US" %>
    ...
    <ContentTemplate>
        ...
        <asp:Panel ID="pnlSelectPager" runat="server" CssClass="pmtbox" meta:resourcekey="pnlSelectPagerResource1">
            <asp:RadioButtonList runat="server" ID="rblPaymentOptions" Style="width: 80%" RepeatDirection="Horizontal"
                ...
                <asp:ListItem Text="PayNearMe" Value="5" meta:resourcekey="ListItemResource5"></asp:ListItem>
            </asp:RadioButtonList>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlPaymentOptions" runat="server">
            <rad:RadMultiPage runat="server" ID="mpPaymentOptions" SelectedIndex="0" meta:resourcekey="mpPaymentOptionsResource1">
                                        ...
                                        <tr>
                                            <td>
                                                <div style="white-space: nowrap" class="gdo-button-margin-lt bttn-addnewcc">
                                                    ...
                                                    <cc2:DynamicButton ID="btnAddNewCreditCard" name="btnAddNewCreditCard" runat="server" ButtonType="Neutral" meta:resourcekey="btnAddNewCreditCardResource1"
                                                        OnClick="btnAddNewCreditCard_Click" Text="Add New Credit Card" />
                                                </div>
                                            </td>
                                            <td>
                                                <cc1:ContentReader ID="ContentReader1" CssClass="PCILeveBox" runat="server" Visible="true" ContentPath="pcilevelbox.html" UseLocal="true"/>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td>
                                    <asp:GridView ID="gridViewCardInfo" runat="server" AutoGenerateColumns="False" OnRowDataBound="gridViewCardInfo_RowDataBound"
                                        ...
                                        CssClass="gdo-order-tbl spacepixel" EnableModelValidation="True">
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Card Holder" meta:resourceKey="hdrCardHolder">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCardHolder" name="lblCardHolder" runat="server" meta:resourceKey="lblCardHolderResource1"
                                            ...
                                            <asp:TemplateField HeaderText="Card Type" meta:resourceKey="hdrCardType">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCardType" name="lblCardType" runat="server" meta:resourceKey="lblCardTypeResource1"
                                            ...
                                            <asp:TemplateField HeaderText="Card Number" meta:resourceKey="hdrCardNumber">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblCardNumber" name="lblCardNumber" runat="server" meta:resourceKey="lblCardNumberResource1"
                                            ...
                                            <asp:TemplateField HeaderText="Expiration" meta:resourceKey="hdrExpiration">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblExp" name="lblExp" runat="server" meta:resourceKey="lblExpResource1" Text='<%# (DateTime.Parse(Eval("Expiration").ToString())==GetMyKeyExpirationDate()) ? "" :Eval("Expiration","{0:MM-yyyy}") %>'></asp:Label>
                ...
                <rad:RadPageView ID="pvPaymentGateway" runat="server" CssClass="MultiPage" meta:resourcekey="pvPaymentGatewayResource1">
                    <asp:Panel runat="server" ID="pnlPaymentGatewayTable" meta:resourcekey="pnlPaymentGatewayTableResource1">
                        <table>
                            ...
                            <tr>
                                <td>
                                    <cc1:ContentReader ID="ContentReader2" CssClass="PCILeveBox" runat="server" Visible="true" ContentPath="pcilevelbox.html" UseLocal="true"/>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <table>
                                        <tr>
                                            <td>
                                                ...
                                                <asp:Label ID="totalWireDue" name="totalWireDue" runat="server" meta:resourcekey="totalWireDueResource1" />
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <rad:RadPageView runat="server" ID="pvPayNearMe" CssClass="MultiPage" meta:resourcekey="pvPayNearMeResource1">
                    <asp:Panel runat="server" ID="pnlPayNearMe" meta:resourcekey="pnlPayNearMeResource1">
                        <table>
                            <tr>
                                <td>
                                    <asp:Label ID="lblPayNearMeAmount" runat="server" Text="Total PayNearMe Amount:" meta:resourcekey="lblPayNearMeAmountResource1" />
                                    <asp:Label ID="totalPayNearMeDue" name="totalPayNearMeDue" runat="server" meta:resourcekey="totalPayNearMeDueResource1" />

                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <cc1:ContentReader ID="crPayNearMe" runat="server" ContentPath="lblPayNearMeMessage.html" SectionName="Ordering" ValidateContent="true" UseLocal="true" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <p>
                                        <strong>
                                            <asp:Literal runat="server" ID="smsMobileTitle" meta:resourcekey="smsMobileTitle">PAYSLIP SMS:</asp:Literal>
                                        </strong>
                                        <br/>
                                        <asp:Literal runat="server" ID="smsMobileMessage" meta:resourcekey="smsMobileMessage">
                                            If you would like to receive PaySlip in a SMS Text Message please provide your mobile phone number below:
                                        </asp:Literal>
                                        <br/> 
                                    </p>
                                    <asp:Label ID="lblSMSMobile" runat="server" Text="SMS Mobile Number:" meta:resourcekey="lblSMSMobileResource1" />
                                    <asp:TextBox runat="server" ID="txtSMSMobile" MaxLength="10" meta:resourcekey="txtSMSMobileResource1"></asp:TextBox>
                                    <span class="gdo-form-format"><asp:Localize ID="smsMobileFormat" runat="server"  meta:resourcekey="smsMobileFormat">Please enter just numbers</asp:Localize></span>
                                </td>
                            </tr>
                        </table>                        
                    </asp:Panel>
            ...
            <asp:Panel ID="pnlAcknowledCheckContent" runat="server" CssClass="errorConfirm" Visible="false">
                <asp:CheckBox runat="server" ID="chkAcknowledgeTransaction" AutoPostBack="true" OnCheckedChanged="AcknowledgeChanged" Text="I acknowledge this transaction" />
            </asp:Panel>
        </asp:Panel>
                ...
                <tr align="right">
                    <td>
                        <asp:Panel class="totalPay" runat="server" ID="pnlGrandTotal" meta:resourcekey="pnlGrandTotalResource1">
                            ...
                            <asp:Label ID="txtGrandTotal" name="txtGrandTotal" runat="server" style="font-weight: bold" readonly="readonly" meta:resourcekey="txtGrandTotalResource1" />
                        </asp:Panel>
                    </td>
                </tr>
            </table>
