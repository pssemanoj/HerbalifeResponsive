<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PaymentInfoGrid_VE.ascx.cs" Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.PaymentInfoGrid_VE" %>
...
<%--<script type="text/javascript" language="javascript">
    function SelectRadioButton(e, ctrl) {
        var selectedRadioButton = null;
        var radioButtons = document.getElementsByTagName("input");

        if (radioButtons.length > 0) {
            selectedRadioButton = e.srcElement;

            for (i = 0; i < radioButtons.length; i++) {
                if (radioButtons[i].value == selectedRadioButton.value && radioButtons[i] != selectedRadioButton) {
...
<script type="text/javascript">
    ...
    function checkAmount(e, ctrl, allowdecimal, amount) {
        var keynum;
        var keychar;
        ...
        if (allowdecimal == 1) {
            var balanceField = findBalanceField();
            var hasCommas = amount.indexOf(',') > -1;
            if (hasCommas) {
                ...
                <rad:RadPageView ID="pvCredit" runat="server" CssClass="MultiPage" meta:resourcekey="pvCreditResource1"
                    ...
                    <asp:Panel runat="server" ID="pnlCreditTable" meta:resourcekey="pnlCreditTableResource1">
                        <table>
                                        ...
                                        <tr>
                                            <td>
                                                <div style="white-space: nowrap" class="gdo-button-margin-lt bttn-addnewcc">
                                                    <cc1:DynamicButton ID="btnAddNewCreditCard" runat="server" ButtonType="Neutral" meta:resourcekey="btnAddNewCreditCardResource1"
                                    ...
                                    <asp:GridView ID="gridViewCardInfo" runat="server" AutoGenerateColumns="False" OnRowDataBound="gridViewCardInfo_RowDataBound"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField meta:resourcekey="TemplateFieldResource3">
                                                <ItemTemplate>
                                                    <cc1:DynamicButton ID="lnkEdit" runat="server" CausesValidation="False" meta:resourceKey="lnkEdit"
                            ...
                            <tr>
                                <td>
                                    <asp:Panel runat="server" ID="pnlTIN">
                                        <br />
                                        <asp:Label runat="server" ID="lblTIN" Text="Cédula de Identidad" meta:resourcekey="lblTINResource"></asp:Label>
                                        <div runat="server" id="divTIN">
                                            <asp:TextBox runat="server" ID="txtTIN" MaxLength="10" 
                                                meta:resourcekey="txtTINResource" Width="70"></asp:TextBox>
                                            <ajaxToolkit:FilteredTextBoxExtender ID="ftxtTIN" runat="server" TargetControlID="txtTIN"
...
<asp:Panel ID="PayOptionsQH" CssClass="gdo-right-column-tbl gdo-hff-module" runat="server"
    Style="border-style: solid; border-width: thin; width: 190px; height: 270; background-color: White"
    Visible="False" meta:resourcekey="PayOptionsQHResource1">
