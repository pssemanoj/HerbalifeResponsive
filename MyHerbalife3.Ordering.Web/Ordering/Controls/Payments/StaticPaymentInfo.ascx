<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="StaticPaymentInfo.ascx.cs"
    Inherits="MyHerbalife3.Ordering.Web.Ordering.Controls.Payments.StaticPaymentInfo" %>
