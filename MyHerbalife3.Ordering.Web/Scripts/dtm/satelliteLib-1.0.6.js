...
function Visitor(t, e) {
    ...
    if (n.isClientSideMarketingCloudVisitorID = function () {
        ...
        n.idSyncContainerID = n.idSyncContainerID || 0, n.f(), T = n.a(g), L = Math.ceil((new Date).getTime() / C.da), !n.idSyncDisableSyncs && I.cb(T, L) && (n.j(S, -1), n.d(g, L)), n.getMarketingCloudVisitorID(), n.getAudienceManagerLocationHint(), n.getAudienceManagerBlob()
    }
...
Visitor.getInstance = function (t, e) {
    ...
    function (t, e, n) {
        ...
        function g(t) {
            w.BaseTool.call(this, t), this.defineListeners(), this.beaconMethod = "plainBeacon", this.adapt = new g.DataAdapters, this.dataProvider = new g.DataProvider.Aggregate
        }
        ...
        w.availableTools = {}, w.availableEventEmitters = [], w.fireOnceEvents = ["condition", "elementexists"], w.initEventEmitters = function () {
        ...
        }, w.availableEventEmitters.push(u), l.prototype.getStringifiedValue = JSON.stringify || w.stringify, l.prototype.initPolling = function () {
            ...
            w.each(this.dataElementsNames, w.bind(function (t) {
                var n = this.getStringifiedValue(w.getVar(t)),
                    i = this.dataElementsStore[t];
                n !== i && (this.dataElementsStore[t] = n, w.onEvent({
        ...
        }, w.availableEventEmitters.push(f), w.inherit(p, w.BaseTool), w.extend(p.prototype, {
            name: "tnt",
            endPLPhase: function (t) {
        ...
        }), w.availableTools.tnt = p, w.inherit(g, w.BaseTool), w.extend(g.prototype, {
            name: "Nielsen",
            endPLPhase: function (t) {
                switch (t) {
                    case "pagetop":
            ...
            initializeDataProviders: function () {
                ...
                this.dataProvider.register(new g.DataProvider.VisitorID(w.getVisitorId())), e ? (t = new g.DataProvider.Generic("rsid", function () {
            ...
            human: !0,
            magicConst: 2e6
        }), g.DataProvider = {}, g.DataProvider.Generic = function (t, e) {
            this.key = t, this.valueFn = e
        }, w.extend(g.DataProvider.Generic.prototype, {
            isReady: function () {
                return !0
            },
            getValue: function () {
        ...
        }), g.DataProvider.VisitorID = function (t, e, n) {
            this.key = e || "uuid", this.visitorInstance = t, this.visitorInstance && (this.visitorId = t.getMarketingCloudVisitorID([this, this._visitorIdCallback])), this.fallbackProvider = n || new g.UUID
        }, w.inherit(g.DataProvider.VisitorID, g.DataProvider.Generic), w.extend(g.DataProvider.VisitorID.prototype, {
            isReady: function () {
        ...
        }, w.extend(g.DataProvider.Aggregate.prototype, {
            register: function (t) {
        ...
        }), g.UUID = function () { }, w.extend(g.UUID.prototype, {
            generate: function () {
        ...
        }), g.DataAdapters = function () { }, w.extend(g.DataAdapters.prototype, {
        ...
        }), w.availableTools.nielsen = g, w.inherit(v, w.BaseTool), w.extend(v.prototype, {
            name: "SC",
            endPLPhase: function (t) {
        ...
        w.inherit(k, w.BaseTool),
            w.extend(k.prototype, {
                name: "GAUniversal",
                endPLPhase: function (t) {
                    var e = this.settings,
                        n = e.loadOn;
                ...
                settings: {
                    ...
                    libraryName: "satelliteLib-1.0.6",
                    isStaging: !1,
                    allowGATTcalls: !1,
                ...
                dataElements: {},
                appVersion: "6L7",
                buildDate: "2016-10-31 16:43:00 UTC",
                publishDate: "2016-10-31 16:42:59 UTC"
            })
    }(window, document);