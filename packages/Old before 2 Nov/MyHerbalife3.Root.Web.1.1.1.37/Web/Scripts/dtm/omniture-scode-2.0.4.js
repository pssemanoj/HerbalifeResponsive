/* AppMeasurement Version 1.7.0 */
/* Last Modified - 09.28.2016 (m.d.Y) */
...
function OmnitureModule() {
    ...
    function setCustomValues(analyticsFacts) {
        ...
        if (typeof values != 'undefined') {
            try {
                ...
                // Bifurcated Site. Traffic Variable ex: prop31 = "TRUE" 
                s_omntr.prop31 = values.bifurcatedSite;
                // Bifurcated Site. Conversion Variable ex eVar31 = "TRUE";
                s_omntr.eVar31 = "D=c31";
    ...
    function getCustomValues(siteData) {
        try {
            ...
            if (regexLoc.test(window.location.pathname.toLowerCase())) {
                customValues.bifurcatedSite = "TRUE";
            }
            var path = (window.location.pathname.toLowerCase()).replace(regexLoc, "");
            ...
            if (pageMapper != null) {
                ...
                if (siteData.orderMonth == "") {
                    if (typeof _orderMonthModel != "undefined" && _orderMonthModel != "" && _orderMonthModel != null) {
                        if (typeof _orderMonthModel.OrderMonth != "undefined" && _orderMonthModel.OrderMonth != "" && _orderMonthModel.OrderMonth != null) {
                            var parsedDate = new Date(parseInt(_orderMonthModel.OrderMonth.substr(6)));

                            var jsDate = new Date(parsedDate);
                            customValues.orderMonth = jsDate.getMonth() + "/" + jsDate.getFullYear();
                        }
                    }
                }
            }
    ...
    function pluginsConf(analyticsFacts) {
        ...
        try {
            if (analyticsFacts.reportSuiteId != "") {
                ...
                s_omntr.Media.trackVars = "events,eVar40,eVar41,eVar43,eVar44";
                s_omntr.Media.trackEvents = "event44,event45,event46,event47,event48";
